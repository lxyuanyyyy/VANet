...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, sample_size=384, sample_duration=144, shortcut_type='B', num_classes=3, last_fc=True):
        ...
        self.layer2 = self._make_layer(block, 192, layers[1], shortcut_type, stride=2)
        self.layer3 = self._make_layer(block, 384, layers[2], shortcut_type, stride=2)
        self.layer4 = self._make_layer(block, 768, layers[3], shortcut_type, stride=2)
        last_duration = math.ceil(sample_duration / 16)
        last_size = math.ceil(sample_size / 48)
        self.avgpool = nn.AdaptiveAvgPool3d(1)

        self.final1 = nn.Linear(768, 16)  # 15360 100  10240 16    8192  35840

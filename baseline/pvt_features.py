...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(512, 3), patch_size=3, in_chans=3, embed_dim=768):
        super().__init__()
...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, img_size=(1, 512), patch_size=3, in_chans=1, num_classes=2,
    ...
    def _get_pos_embed(self, pos_embed, patch_embed, H, W):
        if H * W == self.patch_embed1.num_patches:
            ...
            return F.interpolate(
                ...
                size=(H, W), mode="trilinear").reshape(1, -1, H * W).permute(0, 2, 1)
...
def pvt_tiny(pretrained=False, **kwargs):
    model = PyramidVisionTransformer(
        patch_size=3, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
